  ...
  return (
    <li>
      <Link
        ...
        className="card-accent group relative flex h-full flex-col rounded-2xl border border-ink/[0.14] bg-paper p-7 shadow-sm transition-all duration-300 ease-calm hover:-translate-y-1 hover:border-amber hover:bg-hover-surface hover:shadow-xl hover:shadow-ink/10 sm:p-8"
      >
