...
const outcomes = [
  ...
  },
  {
    ...
    body: "Not a dependency on any one adviser, but a team that thinks in business terms afterwards.",
  },
  {
  ...
  return (
    <>
      <PageBanner
        ...
        intro={
          <p>
            Real cloud and cybersecurity advisory does not just fix the system,
            it leaves the team able to make the next call themselves. The work
            builds business-aligned judgment: the ability to see the decision
            inside the system, and to make it well. The goal is not to be needed
            twice. It is to leave the judgment behind.
          </p>
        }
      >
      ...
      <section className="container-content py-12 sm:py-16">
        <Reveal>
          <div className="rounded-3xl bg-ink p-10 text-paper sm:p-16">
            <p className="kicker text-amber">How the work runs</p>
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_1.1fr] lg:gap-12">
            <Reveal>
              ...
              <p className="mt-6 max-w-prose text-body text-ink">
                A few lines on the situation and the outcome in mind is plenty.
